"""POI-service – FastAPI application entry-point."""
...
from app.api.routers.pois import router as pois_router
...
app = FastAPI(
    title="POI Service",
    description="CRUD, workflow status management and search for Points of Interest",
    version="0.1.0",
    lifespan=lifespan,
)
